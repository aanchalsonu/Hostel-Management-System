<?php
    ...
    if(isset($_GET['del'])) { //checks if the 'del' key is set in the $_GET array, If the key is set, it means that the value of the 'del' parameter can be accessed using $_GET['del'].
        $id=intval($_GET['del']); //Accessing value of del in integer (id) fromat
